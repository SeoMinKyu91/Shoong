	...
	<div id="colorlib-main">
			...
			<div class="modal-footer"> 
            	<form method="post" action="<c:url value="/mypage/diary/story/writeOk.do"/>">
					...
					<input class="form-control" name="imgCount" value="${imgMap.DIARY_IMG_COUNT}"  type="text">
					<input class="form-control" name="imgCode" value="${imgMap.DIARY_IMG_CODE}"  type="text">
					<input class="form-control" name="diaryCode" value="${imgMap.DIARY_CODE}"  type="text">
					<input class="form-control" name="row" value="${row}"  type="text">
