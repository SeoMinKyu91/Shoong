            ...
            <div class="modal-body" style="height: 100%;">
           			<div style="margin-top:10px">
						<form method="post" enctype="multipart/form-data" >
							 <div id="fileUpload" class="dragAndDropDiv"><span class="dragAndDropDivSpan">사진을 올려주세요ㅅ</span></div>
...
//이미지 입력 스크립트.
        ...
        $(document).on("drop",".dragAndDropDiv",function(e){
            $(this).css('border', '2px dashed #777777');
            e.preventDefault();
      ...
      function sendFileToServer(formData)
        {
            ...
            var jqXHR=$.ajax({
                url: "<c:url value="/fileUpload/post"/>",
                type: "POST",
                contentType:false,
                processData: false,
                cache: false,
        ...
        function deleteFileToServer(filename){
   			...
   			$.ajax({
   				url:"<c:url value="/filedelete/post"/>",//요청할 서버의 URL주소
