				...
				<div class="offset-md-2 col-md-8 col-sm-12">
					<div class="row top-menus">
						<div class="col-6 feedwrite">
							 <button type="button" id="btn-feed-write">게시글 추가하기</button>
						</div>
													...
													<div class="col-12 feed-img carousel slide" id="${item.packCommentNo }" data-ride="carousel" data-interval="false">
														...
														<c:if test="${item.packCommentImages.size() > 1 }">
															<ol class="carousel-indicators">
																<c:forEach items="${item.packCommentImages }" var="i" varStatus="index">
														...
														<div class="carousel-inner" role="listbox">
															<c:forEach items="${item.packCommentImages }" var="image" varStatus="index">
																<div 
																	...
																	<img class="feed-img-src" src="/fileupload/${image }" alt="기본사진"/>
																</div>
															</c:forEach>
														</div>
														...
														<!-- Controls -->
														<c:if test="${item.packCommentImages.size() > 1 }">
															<a class="left carousel-control" href="#${item.packCommentNo }" role="button" data-slide="prev" style="background-color: none;">
														    	<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
														    	<span class="sr-only">Previous</span>
													    	</a>
														    <a class="right carousel-control" href="#${item.packCommentNo }" role="button" data-slide="next">
											...
											<div class="feed-bottoms">
												...
												<div class="row feed-bottom-row" style="margin-top:10px;">
													<div class="col-12 feed-reply-show">
														<span style="margin-left:15px;">댓글 </span>
														<span style="margin-left:15px;">${item.packCommentReplyCount }개</span>
														<span><a href="#">모두보기</a></span>
													</div>
												</div>
												
												<div class="row feed-bottom-row">
													<c:if test="${not empty item.packCommentReply }">
														<c:forEach items="${item.packCommentReply }" var="reply">
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form action="" class="" id="feed-write-form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
            	<form method="post" action="<c:url value="/pack/comment/write.do"/>" id="sendToServerForm">
            		<input type="hidden" name="imgArray" id="imgArray" class="form-control">
            		<input type="hidden" name='packCommentContent' id="feed-story-modal">  
            	</form> 
