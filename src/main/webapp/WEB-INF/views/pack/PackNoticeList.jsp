...
<div
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="col-xs-12 col-md-12 col-lg-12">
			<p
				style="padding-top: 14px; padding-left: 10px; color: black; font-weight: bold; font-size: 1.7em; text-align: center">공지사항</p>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
				...
				<form action="" class="bg-light p-5 contact-form"
					...
					<div class="form-group">
						<textarea cols="30" rows="7" class="form-control"
							name="packNoticeContent" id="packNoticeContent"></textarea>
					</div>
				</form>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="" class="bg-light p-5 contact-form"
					...
					<div class="form-group">
						<textarea cols="30" rows="7" class="form-control"
							id="packNoticeEditContent" name="packNoticeContent" value=""></textarea>
					</div>

					<div class="form-group">
						<input type="hidden" class="form-control" name="packNoticeNo"
							id="packNoticeEditNo" value="">
					</div>
					<div class="form-group">
						<input type="hidden" class="form-control" name="nowPage"
							value="${nowPage}">
					</div>
			...
			<div class="modal-footer">
				<button type="button" class="editBtn btn" data-dismiss="modal"
					id="btnNoticeEditOk">수정</button>
				<button type="button" class="editBtn btn" data-dismiss="modal"
					id="btnNoticeEditClose">닫기</button>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="deleteBtn btn" data-dismiss="modal"
					id="btnNoticeDeleteOk">삭제</button>
				<button type="button" class="deleteBtn btn" data-dismiss="modal"
