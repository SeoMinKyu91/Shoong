		...
		<form class="form-horizontal" method="post" name="join"
			...
			<div class="form-group">
				<div class="col-xs-10 offset-xs-1 col-md-10 offset-md-1"
					...
					<h1 style="font-weight: bold; color:#0060A9">회원 가입</h1>
				</div>
				<div class="col-xs-10 offset-xs-1 col-md-8 offset-md-2">
					<!-- 이메일 입력란 -->
					<label for="userId">이메일 </label> <br /> <input type="text"
						id="userId" name="userId"
						style="font-size: .8em; height: 50px; width: 28%"
						placeholder="이메일을 입력하세요"> @ <input type="text"
						id="emailStrinput" name="emailStrinput" placeholder="직접 입력"
						style="font-size: .8em; height: 50px; width: 28%"> <select
						name="emailStr" id="emailStr"
						style="font-size: .8em; height: 50px; width: 28%; border: #ced4da 1.5px solid; color: #7e757d">
					...
					<Button type="button" id="emailDuplCheck" class="btn"
			...
			<div class="form-group">
				<div class="col-xs-10 offset-xs-1 col-md-8 offset-md-2">
					<label for="userPWD">비밀번호<span style="font-size: .8em">&nbsp;(4~12자의
							영문 대소문자와 숫자로만 입력)</span></label> <input type="password" id="userPWD"
			...
			<div class="form-group">
				<div class="col-xs-10 offset-xs-1 col-md-8 offset-md-2">
					<label for="userRRN">생년월일</label> <br /> <input name="userRRN1"
						id="userRRN1" type="text" size="50" maxlength="6"
						...
						id="userRRN2" name="userRRN2" type="text" size="10" maxlength="1"
			...
			<div class="form-group">
				<div class="col-xs-10 offset-xs-1 col-md-8 offset-md-2">
					<label for="userTel">연락처</label><br /> <select name="userTel1"
						id="userTel1"
						style="font-size: .8em; height: 50px; width: 30.1%; padding-left: 10px; border: #ced4da 1.5px solid;">
						...
						maxlength="4" style="height: 50px; width: 30.1%"
						OnKeyUp="checkTel();">&nbsp; ㅡ &nbsp; <input
						name="userTel3" id="userTel3" type="text" maxlength="4"
						style="height: 50px; width: 30.1%" OnKeyUp="checkTel();"> <br />
				</div>
			</div>
			<!-- 활동지역 입력란 -->
			<div class="form-group">
