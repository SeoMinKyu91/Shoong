...
DROP TABLE MEMBER_PROFILE_IMG CASCADE CONSTRAINTS;
...
CREATE SEQUENCE SEQ_M_P_IMG;

/* Create Tables */
CREATE TABLE MEMBER_PROFILE_IMG
(
	MEMBER_PROFILE_IMG_NO number NOT NULL,
	USER_ID varchar2(30),
	PROFILE_IMG_NAME varchar2(50),
	PRIMARY KEY (MEMBER_PROFILE_IMG_NO)
);
...
ALTER TABLE MEMBER_PROFILE_IMG
