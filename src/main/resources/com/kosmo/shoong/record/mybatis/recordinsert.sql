...
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (204,'shoong1000@naver.com',104,'recordsample4.json',24.3,'2021-12-14','7800');
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (205,'shoong1000@naver.com',105,'recordsample5.json',32.4,'2021-1-1','12500');
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (206,'shoong1000@naver.com',106,'recordsample6.json',34,'2021-1-3','13500');
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (207,'shoong1000@naver.com',107,'recordsample7.json',32.4,'2021-1-8','7400');
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (208,'shoong1000@naver.com',108,'recordsample8.json',51,'2021-1-13','17500');
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (209,'shoong1000@naver.com',109,'recordsample9.json',32.4,'2021-1-16','27500');
insert into RECORD_(record_id,user_id,course_id,record_file_name,record_length,record_date) values (210,'shoong1000@naver.com',110,'recordsample10.json',42,'2021-1-17','21500');
